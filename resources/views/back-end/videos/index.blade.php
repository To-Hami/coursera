...
@php
    ...
    $pag_des = 'Here You Can Add / Edit / Delete Videos';
@endphp
    ...
    <div class="card">
        <div class="card-header card-header-primary row">
            ...
            <div class="col-md-4 text-right">
                <a href="{{route('videos.create')}}" class="btn btn-white btn-round">Add {{$moduleName}}</a>
                            ...
                            <td class="td-actions text-right">
                                <button type="button" rel="tooltip" title="" class="btn btn-white btn-link btn-sm"
                                    ...
                                    <i class="material-icons">
                                        <a href="{{route('videos.edit',$row->id)}}"> edit </a>
                                    </i>
                                </button>
