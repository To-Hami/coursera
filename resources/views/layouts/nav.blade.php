<nav class="navbar navbar-expand-lg fixed-top bg-danger " >
    <div class="container">
        <div class="navbar-translate">
            <a class="navbar-brand" href="{{ route('admin') }}" rel="tooltip"
               title="Corsera for web " data-placement="bottom" >
               Your Dashboard
            </a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navigation">
            <ul class="navbar-nav">
                <li class="nav-item ">
                    <a class="nav-link" href="{{route('home')}}" id="navbarDropdownMenuLink" aria-haspopup="true" aria-expanded="false">
                        All Courses
                    </a>
